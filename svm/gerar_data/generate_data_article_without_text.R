...
maFinal <- cbind.fill(subset(dados, select = -c(textParser, id, hashtags, textOriginal, entidades, enriquecimentoTypes, types)), dataFrameHash)
maFinal <- cbind.fill(maFinal, dataFrameEntidades)
save(maFinal, file = "rdas/2gram-entidades-hora-erro-without-text.Rda")