...
w2v <- readr::read_delim("ipmbilstm/exportembedding/ds1/q1/bilstm_10_epocas_menor.txt", 
                  skip=1, delim=" ", quote="",
...
save(X, file = "ipmbilstm/exportembedding/ds1/q1_representacao_bilstm_pca_menor.RData")