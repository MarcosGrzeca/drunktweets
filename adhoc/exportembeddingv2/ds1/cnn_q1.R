...
embedding_result <- "adhoc/exportembeddingv2/ds1/q1/cnn_5_epocas.txt"
die <- 1
maxlen <- 38
max_words <- 7574
questionAval <- "q1"
...
write.table(embedding_matrixTwo, "adhoc/exportembeddingv2/ds1/q1/cnn_10_epocas.txt",sep=" ",row.names=TRUE)
