...
w2v <- readr::read_delim("adhoc/exportembedding/skipgramnonstatic/q2_cnn_10_epocas_8_filters164_skipgram.txt", 
                  skip=1, delim=" ", quote="",
...
save(X, file = "adhoc/redemaluca/skipgramnonstatic/q2_skipgram_cnn_PCA.RData")