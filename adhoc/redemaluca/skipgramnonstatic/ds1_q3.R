...
w2v <- readr::read_delim("adhoc/exportembedding/skipgramnonstatic/q3_cnn_10_epocas_8_filters164_skipgram.txt", 
                  skip=1, delim=" ", quote="",
...
save(X, file = "adhoc/redemaluca/skipgramnonstatic/q3_skipgram_cnn_PCA.RData")