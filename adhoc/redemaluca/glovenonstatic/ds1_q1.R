...
w2v <- readr::read_delim("/var/www/html/drunktweets/adhoc/exportembedding/ds1/q1/cnn_10_epocas_8_filters164_glove.txt", 
                  skip=1, delim=" ", quote="",
...
save(X, file = "adhoc/redemaluca/glovenonstatic/q1_glove_cnn_PCA.RData")