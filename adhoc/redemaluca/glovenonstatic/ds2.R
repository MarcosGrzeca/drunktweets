...
w2v <- readr::read_delim("adhoc/exportembedding/ds2/ds2_cnn_10_epocas_8_filters164_glove.txt", 
                         skip=1, delim=" ", quote="",
...
save(X, file = "adhoc/redemaluca/glovenonstatic/ds2_glove_cnn_PCA.RData")