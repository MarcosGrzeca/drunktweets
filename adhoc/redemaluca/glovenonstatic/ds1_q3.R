...
w2v <- readr::read_delim("adhoc/exportembedding/ds1/q3/cnn_10_epocas_8_filters164_glove.txt", 
                  skip=1, delim=" ", quote="",
...
save(X, file = "adhoc/redemaluca/glovenonstatic/q3_glove_cnn_PCA.RData")