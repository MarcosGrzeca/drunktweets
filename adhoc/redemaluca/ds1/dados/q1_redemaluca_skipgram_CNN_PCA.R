...
w2v <- readr::read_delim("/var/www/html/drunktweets/adhoc/exportembedding/ds1/q1/cnn_10_epocas_8_filters164_skipgram.txt", 
                  skip=1, delim=" ", quote="",
...
X <- cbind(embed,pca_entities$x[,1:13], dados$resposta)
save(X, file = "adhoc/redemaluca/ds1/q1_representacao_skigram_cnn_PCA.RData")