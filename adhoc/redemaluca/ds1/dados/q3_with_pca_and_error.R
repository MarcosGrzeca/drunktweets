...
X <- cbind(embed,pca_entities$x[,1:9], adidionalFeatures, dados$resposta)
save(X, file = "adhoc/redemaluca/ds1/oficial/q3_with_PCA_9_and_error_turno_emoticon.RData")