...
w2v <- readr::read_delim("/var/www/html/drunktweets/adhoc/exportembedding/ds2/cnn_10_epocas_8_filters164_skipgram.txt", 
                  skip=1, delim=" ", quote="",
...
save(X, file = "adhoc/redemaluca/ds2/dados/ds2_representacao_skigram_cnn_PCA.RData")