...
for (iteracao in 1:10) {
  ...
  X <- as(cbind(fbdfm, hashtagsdfm), "dgCMatrix")
  ...
  # X <- as(cbind(fbdfm, hashtagsdfm, typesdfm, entidadesdfm), "dgCMatrix")
  ...
  X <- as(cbind(fbdfm, hashtagsdfm, typesdfm, entidadesdfm, as.matrix(teste)), "dgCMatrix")
