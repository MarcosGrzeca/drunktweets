...
#Geração dos dados
lines <- readLines(file.path("/var/www/html/drunktweets", "adhoc/exportembedding/new_skipgrams_10_epocas_5l_ds2.txt"))
...
embedding_file <- "adhoc/exportembedding/ds2/cnn_10_epocas_8_filters164_skipgram.txt"
