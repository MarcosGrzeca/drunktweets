...
source(file_path_as_absolute("adhoc/exportembedding/skipgramnonstatic/loader.R"))

#adhoc/exportembedding/final_new_skipgrams_10_epocas_5l.txt
...
embedding_file <- "adhoc/exportembedding/skipgramnonstatic/q1_cnn_10_epocas_8_filters164_skipgram.txt"
