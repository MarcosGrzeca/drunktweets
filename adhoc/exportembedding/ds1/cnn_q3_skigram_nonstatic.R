...
#Geração dos dados
lines <- readLines(file.path("/var/www/html/drunktweets", "adhoc/exportembedding/new_skipgrams_10_epocas_5l_q3.txt"))
...
embedding_file <- "adhoc/exportembedding/ds1/q3/cnn_10_epocas_8_filters164_skipgram.txt"
