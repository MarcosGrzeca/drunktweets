...
query <- function(sql) {
  ...
  mydb = dbConnect(MySQL(), user='root', password='senharoot123', dbname=DATABASE, host='icwsmmysql.ckfgeb2fkvqp.sa-east-1.rds.amazonaws.com')
...
connect <- function() {
  dbDataType(RMySQL::MySQL(), "a")
  return (dbConnect(MySQL(), user='root', password='senharoot123', dbname=DATABASE, host='icwsmmysql.ckfgeb2fkvqp.sa-east-1.rds.amazonaws.com'))
}
