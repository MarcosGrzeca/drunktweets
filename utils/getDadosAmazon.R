...
getDadosAmazon <- function() {
  dados <- query('SELECT id,
                      ...
                      (
                        ...
                        AND ty.type IN ("http://dbpedia.org/class/yago/Abstraction100002137", "http://dbpedia.org/class/yago/AdministrativeDistrict108491826", "http://dbpedia.org/class/yago/Community108223802", "http://dbpedia.org/class/yago/District108552138", "http://dbpedia.org/class/yago/Gathering107975026", "http://dbpedia.org/class/yago/Group100031264", "http://dbpedia.org/class/yago/Object100002684", "http://dbpedia.org/class/yago/PhysicalEntity100001930", "http://dbpedia.org/class/yago/SocialGroup107950920", "http://dbpedia.org/class/yago/WikicatAmericanRecordProducers", "http://dbpedia.org/class/yago/WikicatVirtualCommunities", "http://dbpedia.org/class/yago/YagoLegalActorGeo", "http://dbpedia.org/ontology/RecordLabel", "http://www.w3.org/2002/07/owl#Thing")
                        GROUP BY t.id
                      ) AS types,
                      (
                        ...
                        FROM tweets_amazon_nlp tn
                        WHERE tn.idTweet = t.id
                        AND palavra IN ("/food and drink", "Hashtag", "mention", "/food and drink/beverages/alcoholic beverages", "/food and drink/beverages/alcoholic beverages/cocktails and beer", "/religion and spirituality/hinduism", "/food and drink/beverages/alcoholic beverages/wine", "/family and parenting/babies and toddlers/baby clothes", "/law, govt and politics/politics/political parties", "Person", "Hungover")
                        GROUP BY tn.idTweet
                      ) AS entidades
